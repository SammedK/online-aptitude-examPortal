...
{
  $rad = $_POST['a'];
  $qury="SELECT exam2 FROM exam WHERE sr_no = 1";
  ...
  if ($row = $run->fetch_assoc()) {
    ...
    $rad = $_POST['b'];
  $qury="SELECT exam2 FROM exam WHERE sr_no = 2";
  $run=mysqli_query($con,$qury);
  if ($row = $run->fetch_assoc()) {
    if($row["exam2"] == $rad){
    ...
    $rad = $_POST['c'];
  $qury="SELECT exam2 FROM exam WHERE sr_no = 3";
  $run=mysqli_query($con,$qury);
  if ($row = $run->fetch_assoc()) {
    if($row["exam2"] == $rad){
    ...
    $rad = $_POST['d'];
    $qury="SELECT exam2 FROM exam WHERE sr_no = 4";
    $run=mysqli_query($con,$qury);
    if ($row = $run->fetch_assoc()) {
      if($row["exam2"] == $rad){
      ...
      $rad = $_POST['e'];
  $qury="SELECT exam2 FROM exam WHERE sr_no = 5";
  $run=mysqli_query($con,$qury);
  if ($row = $run->fetch_assoc()) {
    if($row["exam2"] == $rad){
    ...
    $rad = $_POST['f'];
  $qury="SELECT exam2 FROM exam WHERE sr_no = 6";
  $run=mysqli_query($con,$qury);
  if ($row = $run->fetch_assoc()) {
    if($row["exam2"] == $rad){
    ...
    $rad = $_POST['g'];
  $qury="SELECT exam2 FROM exam WHERE sr_no = 7";
  $run=mysqli_query($con,$qury);
  if ($row = $run->fetch_assoc()) {
    if($row["exam2"] == $rad){
    ...
    $rad = $_POST['h'];
  $qury="SELECT exam2 FROM exam WHERE sr_no = 8";
  $run=mysqli_query($con,$qury);
  if ($row = $run->fetch_assoc()) {
    if($row["exam2"] == $rad){
    ...
    $rad = $_POST['i'];
  $qury="SELECT exam2 FROM exam WHERE sr_no = 9";
  $run=mysqli_query($con,$qury);
  if ($row = $run->fetch_assoc()) {
    if($row["exam2"] == $rad){
    ...
    $rad = $_POST['j'];
  $qury="SELECT exam2 FROM exam WHERE sr_no = 10";
  $run=mysqli_query($con,$qury);
  if ($row = $run->fetch_assoc()) {
    if($row["exam2"] == $rad){
